 ...
 * @type {string}
 */
const url = ' https://api.openweathermap.org/data/2.5/forecast?q=Novosibirsk&appid=489f5d8cb3792be002e0afb3dad94e52';
...
function getHoursString(dateTime) {
    ...
    return date.getHours().pad();
}

/**
 * Склейка двух значений в строку (костыль мой)
 * @param value
 * @param unit
 * @returns {string}
 */
